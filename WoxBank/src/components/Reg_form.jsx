...
//               autoComplete="name"
//               required
//               className="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-[#33B786] focus:border-[#33B786] focus:z-10 sm:text-sm mb-4"
//               placeholder="Name"
//             />
//             <span className="absolute left-3 top-1/2 transform -translate-y-1/2">
//               <img src="../../public/assets/registrations/fi-rr-user.svg" alt="Name" className="w-5 h-5" />
//             </span>
//           </div>
//           {/* Email Input */}
//           <div className="relative">
...
//               autoComplete="email"
//               required
//               className="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#33B786] focus:border-[#33B786] focus:z-10 sm:text-sm mb-4"
//               placeholder="Email"
//             />
//             <span className="absolute left-3 top-1/2 transform -translate-y-1/2">
...
//               autoComplete="new-password"
//               required
//               className="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-[#33B786] focus:border-indigo-[#33B786] focus:z-10 sm:text-sm mb-4"
//               placeholder="Password"
//             />
//             <span className="absolute left-3 top-1/2 transform -translate-y-1/2">
...
//         <form className="mt-8 space-y-6" action="#" method="POST">
//           {/* Name Input */}
//           <div className="relative flex items-center border border-gray-300 rounded-t-md">
//             <h3 className="text-sm font-medium text-gray-700 absolute -top-6">Name</h3>
//             <input
//               id="name"
//               name="name"
//               type="text"
...
//             <h3 className="text-sm font-medium text-gray-700 absolute -top-6">Email</h3>
//             <input
//               id="email"
//               name="email"
//               type="email"
//               autoComplete="email"
//               required
//               className="appearance-none rounded-none block w-full px-3 py-2 pl-10 border-0 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#33B786] focus:border-[#33B786] sm:text-sm"
//               placeholder="Email"
//             />
//             <span className="absolute right-3">
//               <img src="../path_to_icon/email_icon.svg" alt="Email" className="w-5 h-5" />
...
//           </div>
//           {/* Password Input */}
//           <div className="relative flex items-center border border-gray-300 rounded-b-md">
//             <h3 className="text-sm font-medium text-gray-700 absolute -top-6">Password</h3>
//             <input
//               id="password"
//               name="password"
//               type="password"
