...
const OverView = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24">
      <div className="flex flex-col md:flex-row xl:gap-16">
        {/* Left Section */}
        <div className="flex-1">
          ...
          <section className="mb-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={handleAddAccountForm} className="bg-[#F0F0F0] p-1 rounded-lg" style={{ width: '30px', height: '30px' }}>
        ...
        {/* Right Section */}
        <div className="flex-1">
          <section className="mb-8 md:mr-28 ">
